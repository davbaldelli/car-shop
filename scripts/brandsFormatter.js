export function brandsToCards(brands){
    return brands.map(brand => {
        return `<div class="card m-3 card-brand" id="cardBrandContent" data-key="${brand.name}">
                    <img src="${brand.logo}" class="card-img-top card-image-fit p-2" alt="brand logo" style="height: 230px; width: 350px">
                    <div class="card-body">
