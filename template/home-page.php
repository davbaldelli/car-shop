<div class="col">
    ...
    <section class="row home-section" id="shields-section">
    ...
    <section class="row home-section" id="review">
        ...
        <div class="col-sm review-div">
            <span class="h5-rev ">Auto usate di ottima qualita</span>
            <p class="p-rev ">"recensione del sito e dei prodoti in modo dettagliato e molto esteso, con pareri personali e
                descrizione dell-esperienza dell utente con il prodotto in questione "</p>
        ...
        <div class="col-sm review-div">
            <span class="h5-rev ">Velocissimi e gentilissimi</span>
            <p class="p-rev ">"recensione del sito e dei prodoti in modo dettagliato e molto esteso, con pareri personali e
                descrizione dell-esperienza dell utente con il prodotto in questione "</p>
        ...
        <div class="col-sm review-div">
            <span class="h5-rev ">Consigliatissimo</span>
            <p class="p-rev ">"recensione del sito e dei prodoti in modo dettagliato e molto esteso, con pareri personali e
                descrizione dell-esperienza dell utente con il prodotto in questione "</p>
            <img src="src_img/4_5_stars.png" class="img-stars" alt="grade">
            <span class="p-signature"> Mario R. </span>
